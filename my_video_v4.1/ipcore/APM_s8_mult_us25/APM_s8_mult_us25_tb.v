...
//               
// Library:
// Filename:TB APM_s8_mult_us25_tb.v                 
//////////////////////////////////////////////////////////////////////////////


`timescale 1ns/1ns
module APM_s8_mult_us25_tb();
...
localparam BSIZE = 25 ; //@IPC int 2,72
...
localparam PIPEREG_EN_1 = 0 ; //@IPC enum 0,1
...
localparam PIPE_STATUS = 0 ; //@IPC enum 0,1,2,3,4,5
...
//***************************************************************** DUT  INST ********************************************************************************
APM_s8_mult_us25  U_APM_s8_mult_us25
    (
	.ce     (1'b1),
	.rst    (rst),
	.clk    (clk),
